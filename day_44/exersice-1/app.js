...
const CardList = function () {
  return (
    <div className="course-list row">
      {[1, 2, 3, 4, 5, 6].map((key) => <CardItem key= {key} />)}
    </div>
  )
}
    ...
    <header className="header d-flex align-items-center">
      <div className="container-fluid">
        <div className="d-flex justify-content-start align-items-center">
          ...
          <div className="menu">
            <a className="text-white text-uppercase ms-5" href="#">Phòng lab</a>
            <a className="text-white text-uppercase ms-3" href="#">Trực tuyến</a>
          </div>
        </div>
      </div>
    </header>
      ...
      <div className="container">
        <div className="row">
          ...
          <div className="col-lg-3">
            ...
            <p>Cơ sở 3: Tầng 5, số 13 Dịch Vọng Hậu, Cầu Giấy, Hà Nội</p>
          </div>
        </div>
      </div>
    </footer>
